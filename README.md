...
### 7-1. 잘한 점
- CSS와 JS 파일 구조를 세분화하고 파일별 전담 담당자를 지정함으로써, 협업 중 발생할 수 있는 깃허브 코드 충돌을 예방하고 병합 프로세스를 단순화할 수 있었다.
- 팀원 간 개인 일정과 작업 가능 시간대의 불일치로 발생할 수 있는 작업 지연 문제를 태스크 단위의 철저한 역할 분담과 독립적 개발 환경 구축을 통해 극복했다.
