...
>
<path
d="M25.6677 14H18.6672L16.3336 17.4997H11.6666L9.33308 14H2.33252M2.33252 14L6.35784 5.96247C6.55103 5.57376 6.84884 5.24664 7.2178 5.01789C7.58675 4.78914 8.01221 4.66783 8.44634 4.6676H19.5539C19.988 4.66783 20.4135 4.78914 20.7824 5.01789C21.1514 5.24664 21.4492 5.57376 21.6424 5.96247L25.6677 14V20.9993C25.6677 21.6181 25.4219 22.2115 24.9842 22.6491C24.5466 23.0866 23.9531 23.3324 23.3342 23.3324H4.66604C4.04715 23.3324 3.45361 23.0866 3.01599 22.6491C2.57837 22.2115 2.33252 21.6181 2.33252 20.9993V14Z"
stroke="#D5D5D5"
stroke-width="2"
...
export function renderBoard(todos, {
  ...
  renderColumn(todoList, todo, { onEditTodo, onDeleteTodo });
  renderColumn(doingList, doing, { onEditTodo, onDeleteTodo });
  renderColumn(doneList, done, { onEditTodo, onDeleteTodo });
